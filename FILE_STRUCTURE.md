...
| --- | --- | --- |
| สไลด์ ITF ที่ `summary.md` เขียนว่าห้ามเผยแพร่ | 77 ไฟล์สาธารณะ | ต้องขออนุญาตผู้สอน หรือย้ายไปหลังประตู |
| workbook FE (Edusoft) ที่ระบุว่าให้อยู่หลังล็อกอิน | 3 ไฟล์สาธารณะ | ลิขสิทธิ์ของผู้จัดพิมพ์ |
| ไฟล์ `-completed` (งานที่ทำส่งแล้ว) | 27 ไฟล์สาธารณะ | PII ของเจ้าของ repo เอง |
| งานกลุ่ม `lab06-*group*` | 2 ไฟล์สาธารณะ | พบรหัสนักศึกษาที่ไม่ใช่ของเจ้าของ repo (`66899515`) — PII ของบุคคลที่สาม |
