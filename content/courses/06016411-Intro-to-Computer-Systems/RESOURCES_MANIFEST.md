...
| ------------------------------------------------- | ---: | ------: | --- | ------- | :-----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------- |
| `ics-lec-week01-introduction.pdf`                 |   12 | 1008 KB | A   | เก่า    |   —     | หน้าปก _Introduction to Computer Systems · Lecture 1_ (ฉบับเดิม มีปัญหาขอบหน้าถูกตัด เลี่ยงไปใช้ฉบับ v2)                                                                       | `Digital Systems` `Logic Gate`                     |
| `ics-lec-week01-v2.pdf`                           |   12 |  463 KB | A   | หลัก    |   ✅    | หน้าปก _Introduction to Computer Systems · Lecture 1_ ฉบับสมบูรณ์ไม่ตัดขอบ — เปิดวิชา อธิบาย analog vs digital, logic gate (`scope: midterm`, `chapter: 1`)                   | `Digital Systems` `Logic Gate`                     |
| `ics-lec-week02-boolean-algebra.pdf`              |   23 |  253 KB | A   | เก่า    |   —     | หน้าปก _Boolean Algebra · Lecture 2_ (ฉบับเดิม มีปัญหาขอบหน้าถูกตัด เลี่ยงไปใช้ฉบับ v2)                                                                                          | `Boolean Algebra` `De Morgan`                      |
| `ics-lec-week02-boolean.pdf`                      |   23 |  402 KB | A   | ซ้ำ     |    —    | เนื้อหาเดียวกับ `week02-v2` ทุกหน้า (RMSE 0.0000)                                                                                                                              | `Boolean Algebra`                                  |
| `ics-lec-week02-v2.pdf`                           |   23 |  672 KB | A   | หลัก    |   ✅    | หน้าปก _Boolean Algebra · Lecture 2_ ฉบับสมบูรณ์ไม่ตัดขอบ — กฎพีชคณิตบูลีน De Morgan การแปลงสมการ↔ตารางความจริง↔วงจร (`scope: midterm`, `chapter: 2`)                           | `Boolean Algebra` `De Morgan`                      |
| `ics-lec-week03-canonical-forms.pdf`              |   15 |  205 KB | A   | เก่า    |   —     | หน้าปก _Canonical Forms · Lecture 3_ (ฉบับเดิม มีปัญหาขอบหน้าถูกตัด เลี่ยงไปใช้ฉบับ v2)                                                                                          | `Canonical Forms` `SOP/POS` `Minterm`              |
...
| `ics-lec-week03-v2.pdf`                           |   16 |  540 KB | A   | หลัก    |   ✅    | หน้าปก _Canonical Forms · Lecture 3_ ฉบับสมบูรณ์ไม่ตัดขอบ 16 หน้า — minterm/maxterm, SOP/POS, don't care (`scope: midterm`, `chapter: 3`)                                     | `Canonical Forms` `SOP/POS` `Minterm`              |
