...
|---|:---:|---|---|---|
| ครึ่งแรก | 1–7 | ดิจิทัลลอจิก — เลขฐาน · บูลีน · SOP/POS · K-map · timing · MUX/DEMUX | ศ.ดร. สุขสันต์ พาณิชพาพิบูล | **กลางภาค 50%** |
...
ตัวเลข "สัปดาห์ 1–7" ในหน้านี้เป็นลำดับคาบของ ผศ.ดร. สุภกิจ เอง ซึ่งตรงกับ
**ครั้งที่ 8–15 ของประมวลการสอน** ไม่ใช่สัปดาห์ 1–7 ที่ใช้สอบกลางภาค

> ✅ [`summary.md`](../summary) ของวิชานี้แก้ตามประมวลการสอนแล้ว — หัวข้อ 1 และ 2
> เขียนตรงกับหน้านี้ว่าสไลด์สองชุดคือครึ่งแรกและครึ่งหลังของวิชาเดียวกัน
> ข้ามชุดใดชุดหนึ่งคือข้ามครึ่งเทอม
...
| ตำรา *Introduction to Computer System* v0.5 | 251 | เขียนโดย ผศ.ดร. สุภกิจ นุตยะสกุล |
...
และไม่ได้ระบุตำรา ICS v0.5 ของ ผศ.ดร. สุภกิจ ไว้ในรายการหนังสือแนะนำ
...
> [`summary.md` หัวข้อ 1](../summary) ใช้ตัวเลขชุดนี้แล้ว และบันทึกไว้ด้วยว่าสไลด์รุ่นก่อนหน้า
> เคยระบุ Quiz 15% · **Lab Quiz 15%** · Final 10% · **Lab Exam 10%**
...
สไลด์ตารางเรียนของ ผศ.ดร. สุภกิจ **ไม่มีสอบกลางภาคในช่วงของท่าน** — มี quiz 7 ครั้ง,
...
**ตำราหลัก**
- ผศ.ดร. สุภกิจ นุตยะสกุล, *Introduction to Computer System* (ฉบับ v0.5) — อยู่ในคลังของวิชา
