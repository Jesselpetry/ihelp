...
|---|---|
| **รหัสวิชา** | `06066301` |
| **ชื่อภาษาไทย** | โครงสร้างข้อมูลและอัลกอริทึม |
| **ชื่อภาษาอังกฤษ** | Data Structures and Algorithms |
| **หน่วยกิต** | 3 (3-0-6) |
| **ระดับการศึกษา** | ปริญญาตรี |
| **ชั้นปี / ภาคการศึกษา** | ปี 1 เทอม 2 (Y1-S2) |
| **วิชาบังคับก่อน** | ไม่มีวิชาบังคับก่อน |
| **อาจารย์ผู้สอน** | ผศ.ดร. สุพัณณดา โชติพันธ์ (ผู้ช่วยคณบดี) · ดร. ภัทรภร วัฒนาชีพ |
