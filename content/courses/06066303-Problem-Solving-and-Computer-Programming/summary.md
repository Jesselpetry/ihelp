...
|---|---|
| รหัสวิชา | `06066303` |
| ชื่อไทย | การแก้ปัญหาและการโปรแกรมคอมพิวเตอร์ |
| ชื่ออังกฤษ | PROBLEM SOLVING AND COMPUTER PROGRAMMING |
| หน่วยกิต | 3 (2-2-5) |
...
แนวคิดและเกริ่นนำการเขียนโปรแกรมคอมพิวเตอร์
...
ตามชุดโจทย์จริงบน iJudge (Course 78) และ quiz ในคลัง หัวข้อหลังกลางภาคครอบคลุมการประยุกต์ใช้โครงสร้างข้อมูลและอัลกอริทึม:
...
| **Week 14** | **Sorting & Searching Algorithms** | Bubble sort, Selection sort, Insertion sort, Merge sort, Binary search | `PSCP_Ex_SortingTest.pdf`, Quiz Week 14 |

> ⭐ = โจทย์ติดป้าย `[LEARNING LOGS]` บังคับส่งรายงานสรุปการเรียนรู้ (`submission.md` + `ai_reflection.md`) ผ่านเครื่องมือสร้างรายงานบน iHelp
...
**สัปดาห์ 8–9 บน iJudge** ⭐ (ครอบคลุมในข้อสอบปลายภาค)
- **สัปดาห์ 8 — Nested loop วาดรูป** — ลูปนอกคุมแถว (row) ลูปในคุมคอลัมน์ (col)
...
- **สัปดาห์ 9 — List และการจำลอง** — วนบน list เพื่อกรอง/แปลง/นับ, การย่อช่วงเลข
...
โจทย์ 135 ข้อในคลัง `pscp-69070027/oj_problems.json` ครอบคลุมสัปดาห์ที่ 1–9
